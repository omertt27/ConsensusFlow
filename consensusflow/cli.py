...
Usage:
    ...
    consensusflow "Plan a trip to Istanbul" --chain gpt-4o gemini/gemini-1.5-pro claude-3-5-sonnet-20241022
...
Examples:
  ...
  consensusflow "What time does Topkapi Palace open?" --chain gpt-4o gemini/gemini-1.5-pro claude-3-5-sonnet-20241022
  consensusflow "Plan a 2-day Istanbul trip" --output markdown > report.md
  consensusflow "..." --stream --output terminal
  consensusflow "..." --budget 0.05 --fallback gpt-4-turbo gemini/gemini-1.5-flash claude-3-haiku-20240307
        """,
    )
    parser.add_argument(
        "prompt",
